 ...
 */
this.autointegrate_version = "AutoIntegrate v1.57.1 test1";       // Version, also updated into updates.xri
this.autointegrate_info = "CometAlignment, GUI updates, fixes";   // For updates.xri
