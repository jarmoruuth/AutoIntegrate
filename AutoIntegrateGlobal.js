 ...
 */
this.autointegrate_version = "AutoIntegrate v1.55";         // Version, also updated into updates.xri
this.autointegrate_info = "Support for BlurXTerminator.";   // For updates.xri
