 ...
 */
this.autointegrate_version = "AutoIntegrate v1.87.2 test2"; // Version, also updated into updates.xri
...
/* GUI controls that are created for options in this.par. Filled by util.recordParam
 * when a control is created. Used to write the option metadata file that is used to
 * generate the options documentation, see writeOptionsMetadata in AutoIntegrateGUI.js.
 */
this.gui_controls = [];
...
/*
      ...
      Optional field applies tells what kind of data an option applies to. It is
      used to tag the options in the generated options documentation, see
      GenerateOptionsPage.py. It can have any of the following words:

            interface   Affects only the user interface, files on disk or logging,
                        not the processed image. Without this an option is assumed
                        to change the processed image.
            color       Applies to color images. Both OSC/DSLR data and RGB that is
                        combined from mono channels are color images.
            osc         Applies only to undebayered OSC, DSLR or RAW data.
            narrowband  Applies to narrowband data or narrowband palettes.
            mono        Applies to mono data with separate filter channels.

      Options that use an external tool are recognized from the option name and
      do not need the applies field.
*/
this.par = {
      ...
      GC_before_channel_combination: { val: false, def: false, name : "GC before channel combination", type : 'B', oldname: "ABE before channel combination", applies : "mono" },
      ...
      use_background_neutralization: { val: false, def: false, name : "Background neutralization", type : 'B', applies : "color" },
      ...
      skip_SCNR: { val: false, def: false, name : "No SCNR", type : 'B', applies : "color" },
      ...
      // Saving image
      save_final_image_tiff: { val: false, def: false, name : "Save final image as TIFF", type : 'B', applies : "interface" },
      save_final_image_jpg: { val: false, def: false, name : "Save final image as JPG", type : 'B', applies : "interface" },
      save_final_image_jpg_quality: { val: 80, def: 80, name : "Save final image as JPG quality", type : 'I', applies : "interface" },
      ...
      image_weight_testing: { val: false, def: false, name : "Image weight testing", type : 'B', applies : "interface" },
      early_PSF_check: { val: false, def: false, name : "Early PSF check", type : 'B' },
      debayer_only: { val: false, def: false, name : "Debayer only", type : 'B', applies : "color osc" },
      binning_only: { val: false, def: false, name : "Binning only", type : 'B' },
      extract_channels_only: { val: false, def: false, name : "Extract channels only", type : 'B', applies : "color osc" },
      integrate_only: { val: false, def: false, name : "Integrate only", type : 'B' },
      channelcombination_only: { val: false, def: false, name : "ChannelCombination only", type : 'B', applies : "mono" },
      cropinfo_only: { val: false, def: false, name : "Crop info only", type : 'B' },
      RRGB_image: { val: false, def: false, name : "RRGB", type : 'B', applies : "color mono" },
      ...
      select_all_files: { val: false, def: false, name : "Select all files", type : 'B', applies : "interface" },
      save_all_files: { val: false, def: false, name : "Save all files", type : 'B', applies : "interface" },
      save_processed_channel_images: { val: false, def: false, name : "Save processed channel images", type : 'B', applies : "interface mono" },
      save_stretched_starless_channel_images: { val: false, def: false, name: "Save starless channel images", type: 'B', applies : "interface mono" },
      stretched_channel_auto_contrast: { val: false, def: false, name : "Stretched channel auto contrast", type : 'B', applies : "mono" },
      no_subdirs: { val: false, def: false, name : "No subdirectories", type : 'B', applies : "interface" },
      create_process_icons: { val: true, def: true, name : "Create process icons", type : 'B', applies : "interface" },
      ...
      debug: { val: false, def: false, name : "Debug", type : 'B', applies : "interface" },
      null_processing: { val: false, def: false, name : "Null processing", type : 'B', applies : "interface" },
      flowchart_debug: { val: false, def: false, name : "Flowchart debug", type : 'B', applies : "interface" },
      print_process_values: { val: false, def: false, name : "Print process values", type : 'B', applies : "interface" },
      create_executed_processes_js: { val: false, def: false, name : "Create ExecutedProcesses.js file", type : 'B', applies : "interface" },
      monochrome_image: { val: false, def: false, name : "Monochrome", type : 'B', applies : "mono" },
      skip_imageintegration_clipping: { val: false, def: false, name : "No ImageIntegration clipping", type : 'B' },
      synthetic_l_image: { val: false, def: false, name : "Synthetic L", type : 'B', applies : "mono" },
      synthetic_missing_images: { val: false, def: false, name : "Synthetic missing image", type : 'B', applies : "mono" },
      force_file_name_filter: { val: false, def: false, name : "Use file name for filters", type : 'B' },
      unique_file_names: { val: false, def: false, name : "Unique file names", type : 'B', applies : "interface" },
      use_starxterminator: { val: false, def: false, name : "Use StarXTerminator", type : 'B' },
      run_get_flowchart_data: { val: false, def: false, name : "Run get flowchart data", type : 'B', skip_reset: true, applies : "interface" },
      flowchart_background_image: { val: true, def: true, name : "Flowchart background image", type : 'B', skip_reset: true, applies : "interface" },
      flowchart_time: { val: true, def: true, name : "Flowchart time", type : 'B', skip_reset: true, applies : "interface" },
      flowchart_saveimage: { val: false, def: false, name : "Flowchart save image", type : 'B', skip_reset: true, applies : "interface" },
      ...
      autosave_setup: { val: true, def: true, name: "Autosave setup", type: 'B', applies : "interface" },
      use_processed_files: { val: false, def: false, name: "Use processed files", type: 'B' },
      save_cropped_images: { val: false, def: false, name: "Save cropped images", type: 'B', applies : "interface" },

      open_directory: { val: false, def: false, name: "Open directory", type: 'B', applies : "interface" },
      directory_files: { val: "*.fits *.fit", def: "*.fits *.fit", name : "Directory files", type : 'S', applies : "interface" },

      // astrobin variables
      astrobin_L: { val: "", def: "", name : "AstroBin L", type : 'S', skip_reset: true, applies : "interface" },
      astrobin_R: { val: "", def: "", name : "AstroBin R", type : 'S', skip_reset: true, applies : "interface" },
      astrobin_G: { val: "", def: "", name : "AstroBin G", type : 'S', skip_reset: true, applies : "interface" },
      astrobin_B: { val: "", def: "", name : "AstroBin B", type : 'S', skip_reset: true, applies : "interface" },
      astrobin_H: { val: "", def: "", name : "AstroBin H", type : 'S', skip_reset: true, applies : "interface" },
      astrobin_S: { val: "", def: "", name : "AstroBin S", type : 'S', skip_reset: true, applies : "interface" },
      astrobin_O: { val: "", def: "", name : "AstroBin O", type : 'S', skip_reset: true, applies : "interface" },
      astrobin_C: { val: "", def: "", name : "AstroBin C", type : 'S', skip_reset: true, applies : "interface" },

      // Narrowband processing
      narrowband_mapping: { val: this.narrowBandPalettes[0].name, def: this.narrowBandPalettes[0].name, name : "Narrowband mapping", type : 'S', used: true, applies : "narrowband" },
      custom_R_mapping: { val: this.narrowBandPalettes[0].R, def: this.narrowBandPalettes[0].R, name : "Narrowband R mapping", type : 'S', applies : "narrowband" },
      custom_G_mapping: { val: this.narrowBandPalettes[0].G, def: this.narrowBandPalettes[0].G, name : "Narrowband G mapping", type : 'S', applies : "narrowband" },
      custom_B_mapping: { val: this.narrowBandPalettes[0].B, def: this.narrowBandPalettes[0].B, name : "Narrowband B mapping", type : 'S', applies : "narrowband" },
      custom_L_mapping: { val: 'Auto', def: 'Auto', name : "Narrowband L mapping", type : 'S', applies : "narrowband mono" },
      narrowband_linear_fit: { val: 'Auto', def: 'Auto', name : "Narrowband linear fit", type : 'S', applies : "narrowband" },
      mapping_on_nonlinear_data: { val: false, def: false, name : "Narrowband mapping on non-linear data", type : 'B', applies : "narrowband" },
      force_narrowband_mapping: { val: false, def: false, name : "Force narrowband mapping", type : 'B', applies : "narrowband" },
      ...
      remove_stars_channel: { val: false, def: false, name : "Remove stars channel", type : 'B', applies : "mono" },
      remove_stars_stretched: { val: false, def: false, name : "Remove stars stretched", type : 'B' },
      create_RGB_stars: { val: false, def: false, name : "RGB stars", type : 'B', applies : "color" },
      use_narrowband_multiple_mappings: { val: false, def: false, name : "Use narrowband multiple mappings", type : 'B', applies : "narrowband" },
      narrowband_multiple_mappings_list: { val: "", def: "", name : "Narrowband multiple mappings list", type : 'S', applies : "narrowband" },

      // Ha to RGB mapping
      use_RGBHa_Mapping: { val: false, def: false, name : "Ha RGB mapping", type : 'B', applies : "narrowband" },
      RGBHa_preset: { val: 'Combine Continuum Subtract', def: 'Combine Continuum Subtract', name : "Ha RGB mapping preset", type : 'S', applies : "narrowband" },
      RGBHa_prepare_method: { val: 'Continuum Subtract', def: 'Continuum Subtract', name : "Ha RGB mapping prepare method", type : 'S', applies : "narrowband" },
      RGBHa_combine_time: { val: 'Stretched', def: 'Stretched', name : "Ha RGB mapping combine time", type : 'S', applies : "narrowband" },
      RGBHa_combine_method: { val: 'Bright structure add', def: 'Bright structure add', name : "Ha RGB mapping combine method", type : 'S', applies : "narrowband" },
      RGBHa_noise_reduction: { val: true, def: true, name : "Ha RGB mapping noise reduction", type : 'B', applies : "narrowband" },
      RGBHa_boost: { val: 1.0, def: 1.0, name : "Ha RGB boost", type : 'R', applies : "narrowband" },
      RGBHa_gradient_correction: { val: false, def: false, name : "Ha RGB mapping gradient correction", type : 'B', applies : "narrowband" },
      RGBHa_smoothen_background: { val: false, def: false, name : "Ha RGB mapping smoothen background", type : 'B', applies : "narrowband" },
      RGBHa_smoothen_background_value: { val: 25, def: 25, name : "Ha RGB mapping smoothen background value", type : 'R', applies : "narrowband" },
      RGBHa_remove_stars: { val: false, def: false, name : "Ha RGB mapping remove stars", type : 'B', applies : "narrowband" },
      RGBHa_Combine_BoostFactor: { val: 1.0, def: 1.0, name : "Ha RGB mapping combine boost factor", type : 'R', applies : "narrowband" },
      RGBHa_Add_BoostFactor: { val: 0.5, def: 0.5, name : "Ha RGB mapping SPCC boost factor", type : 'R', applies : "narrowband" },
      RGBHa_test_value: { val: 'Mapping', def: 'Mapping', name : "Narrowband RGB mapping O bandwidth", type : 'R', applies : "interface narrowband" },
      
      // Narrowband to RGB mapping
      use_RGBNB_Mapping: { val: false, def: false, name : "Narrowband RGB mapping", type : 'B', applies : "narrowband" },
      RGBNB_use_RGB_image: { val: false, def: false, name : "Narrowband RGB mapping use RGB", type : 'B', applies : "narrowband" },
      RGBNB_gradient_correction: { val: false, def: false, name : "Narrowband RGB mapping gradient correction", type : 'B', applies : "narrowband" },
      RGBNB_linear_fit: { val: false, def: false, name : "Narrowband RGB mapping linear fit", type : 'B', applies : "narrowband" },
      RGBNB_L_mapping: { val: '',  def: '',  name : "Narrowband RGB mapping for L", type : 'S', applies : "narrowband" },
      RGBNB_R_mapping: { val: 'H', def: 'H', name : "Narrowband RGB mapping for R", type : 'S', applies : "narrowband" },
      RGBNB_G_mapping: { val: '', def: '', name : "Narrowband RGB mapping for G", type : 'S', applies : "narrowband" },
      RGBNB_B_mapping: { val: '', def: '', name : "Narrowband RGB mapping for B", type : 'S', applies : "narrowband" },
      RGBNB_L_BoostFactor: { val: 1.2, def: 1.2, name : "Narrowband RGB mapping L boost factor", type : 'R', applies : "narrowband" },
      RGBNB_R_BoostFactor: { val: 1.2, def: 1.2, name : "Narrowband RGB mapping R boost factor", type : 'R', applies : "narrowband" },
      RGBNB_G_BoostFactor: { val: 1.2, def: 1.2, name : "Narrowband RGB mapping G boost factor", type : 'R', applies : "narrowband" },
      RGBNB_B_BoostFactor: { val: 1.2, def: 1.2, name : "Narrowband RGB mapping B boost factor", type : 'R', applies : "narrowband" },
      RGBNB_L_bandwidth: { val: 300, def: 300, name : "Narrowband RGB mapping L bandwidth", type : 'R', applies : "narrowband" },
      RGBNB_R_bandwidth: { val: 100, def: 100, name : "Narrowband RGB mapping R bandwidth", type : 'R', applies : "narrowband" },
      RGBNB_G_bandwidth: { val: 100, def: 100, name : "Narrowband RGB mapping G bandwidth", type : 'R', applies : "narrowband" },
      RGBNB_B_bandwidth: { val: 100, def: 100, name : "Narrowband RGB mapping B bandwidth", type : 'R', applies : "narrowband" },
      RGBNB_H_bandwidth: { val: 3, def: 3, name : "Narrowband RGB mapping H bandwidth", type : 'R', applies : "narrowband" },
      RGBNB_S_bandwidth: { val: 3, def: 3, name : "Narrowband RGB mapping S bandwidth", type : 'R', applies : "narrowband" },
      RGBNB_O_bandwidth: { val: 3, def: 3, name : "Narrowband RGB mapping O bandwidth", type : 'R', applies : "narrowband" },

      // Processing settings
      auto_noise_reduction: { val: true, def: true, name : "Auto noise reduction", type : 'B' },
      channel_noise_reduction: { val: false, def: false, name : "Channel noise reduction", type : 'B', applies : "mono" },
      ...
      luminance_noise_reduction_strength: { val: 3, def: 3, name : "Noise reduction strength on luminance image", type : 'I', applies : "mono" },
      ...
      use_color_noise_reduction: { val: false, def: false, name : "Color noise reduction", type : 'B', applies : "color" },
      ...
      use_linear_fit: { val: 'Auto', def: 'Auto', name : "Linear fit", type : 'S', applies : "color" },
      ...
      MAS_colorSaturation: { val: true, def: true, name : "MAS color saturation", type : 'B', applies : "color" }, 
      MAS_colorSaturation_amount: { val: 0.75, def: 0.75, name : "MAS color saturation amount", type : 'R', applies : "color" },
      MAS_colorSaturation_boost: { val: 0.5, def: 0.5, name : "MAS color saturation boost", type : 'R', applies : "color" },
      MAS_colorSaturation_lightness: { val: true, def: true, name : "MAS color saturation lightness", type : 'B', applies : "color" },
      ...
      veralux_color_strategy: { val: 0, def: 0, name : "VeraLux color strategy", type : 'I', applies : "color" },
      veralux_color_grip: { val: 1.0, def: 1.0, name : "VeraLux color grip", type : 'R', applies : "color" },
      veralux_shadow_convergence: { val: 1.0, def: 1.0, name : "VeraLux shadow convergence", type : 'R' },

      LRGBCombination_lightness: { val: 0.5, def: 0.5, name : "LRGBCombination lightness", type : 'R', applies : "color mono" },    
      LRGBCombination_saturation: { val: 0.5, def: 0.5, name : "LRGBCombination saturation", type : 'R', applies : "color mono" },    
      LRGBCombination_linearfit: { val: false, def: false, name : "LRGBCombination linear fit", type : 'B', applies : "color mono" },
      linear_increase_saturation: { val: 1, def: 1, name : "Linear saturation increase", type : 'I', applies : "color" },    
      non_linear_increase_saturation: { val: 1, def: 1, name : "Non-linear saturation increase", type : 'I', applies : "color" },    
      use_chrominance: { val: false, def: false, name : "Use chrominance", type : 'B', applies : "color mono" },
      ...
      spcc_detection_scales: { val: 5, def: 5, name : "SPCC detection scales", type : 'I', applies : "color" }, 
      spcc_noise_scales: { val: 1, def: 1, name : "SPCC noise scales", type : 'I', applies : "color" }, 
      spcc_min_struct_size: { val: 0, def: 0, name : "SPCC min struct size", type : 'I', applies : "color" }, 
      spcc_red_wavelength: { val: 671.60, def: 671.60, name : "SPCC red wavelength", type : 'R', applies : "color" },
      spcc_red_bandwidth: { val: 3, def: 3, name : "SPCC red bandwidth", type : 'R', applies : "color" },
      spcc_green_wavelength: { val: 656.30, def: 656.30, name : "SPCC green wavelength", type : 'R', applies : "color" },
      spcc_green_bandwidth: { val: 3, def: 3, name : "SPCC green bandwidth", type : 'R', applies : "color" },
      spcc_blue_wavelength: { val: 500.70, def: 500.70, name : "SPCC blue wavelength", type : 'R', applies : "color" },
      spcc_blue_bandwidth: { val: 3, def: 3, name : "SSPCC blue bandwidth", type : 'R', applies : "color" },
      spcc_narrowband_mode: { val: false, def: false, name : "SPCC narrowband mode", type : 'B', applies : "color narrowband" },
      spcc_background_neutralization: { val: true, def: true, name : "SPCC background neutralization", type : 'B', applies : "color" },
      spcc_auto_narrowband: { val: true, def: true, name : "SPCC narrowband auto mode", type : 'B', applies : "color narrowband" },
      spcc_white_reference: { val: 'Average Spiral Galaxy', def: 'Average Spiral Galaxy', name : "SPCC white reference", type : 'S', applies : "color" },
      spcc_limit_magnitude: { val: 'Auto', def: 'Auto', name : "SPCC limit magnitude", type : 'S', applies : "color" },
      spcc_saturation_threshold: { val: 0.75, def: 0.75, name : "SPCC saturation threshold", type : 'R', applies : "color" },
      spcc_min_SNR: { val: 40, def: 40, name : "SPCC min SNR", type : 'R', applies : "color" },
      color_calibration_narrowband: { val: false, def: false, name : "ColorCalibration narrowband", type : 'B', applies : "color narrowband" },
      color_calibration_time: { val: 'auto', def: 'auto', name : "ColorCalibration time", type : 'S', applies : "color" },

      // Extra processing for narrowband
      run_foraxx_mapping: { val: false, def: false, name : "Enh Foraxx mapping", type : 'B', oldname: "Extra Foraxx mapping", applies : "narrowband"},
      foraxx_palette: { val: "SHO", def: "SHO", name : "Enh Foraxx palette", type : 'S', oldname: "Extra Foraxx palette", applies : "narrowband"},
      run_enhancements_narrowband_mapping: { val: false, def: false, name : "Enh narrowband mapping", type : 'B', oldname: "Extra narrowband mapping", applies : "narrowband" },
      enhancements_narrowband_mapping_source_palette: { val: "SHO", def: "SHO", name : "Enh narrowband mapping source palette", type : 'S', oldname: "Extra narrowband mapping source palette", applies : "narrowband" },
      enhancements_narrowband_mapping_target_palette: { val: "HOS", def: "HOS", name : "Enh narrowband mapping target palette", type : 'S', oldname: "Extra narrowband mapping target palette", applies : "narrowband" },
      run_orangeblue_colors: { val: false, def: false, name : "Enh orangeblue colors", type : 'B', oldname: "Extra orangeblue colors", applies : "narrowband" },
      run_orange_hue_shift: { val: false, def: false, name : "Enh narrowband more orange", type : 'B', oldname: "Extra narrowband more orange", applies : "narrowband" },
      run_hue_shift: { val: false, def: false, name : "Enh narrowband hue shift", type : 'B', oldname: "Extra narrowband hue shift", applies : "narrowband" },

      enhancements_selective_color: { val: false, def: false, name : "Enh selective color", type : 'B', applies : "color" },
      enhancements_selective_color_preset: { val: "None", def: "None", name : "Enh selective color preset", type : 'S', applies : "color" },
      enhancements_selective_color_data: { val: null, def: null, name : "Enh selective color data", type : 'O', applies : "color" },
      ...
      leave_some_green: { val: false, def: false, name : "Enh narrowband leave some green", type : 'B', oldname: "Extra narrowband leave some green", applies : "narrowband" },
      leave_some_green_amount: { val: 0.50, def: 0.50, name : "Enh narrowband leave some green amount", type : 'R', oldname: "Extra narrowband leave some green amount", applies : "narrowband" },
      run_narrowband_SCNR: { val: false, def: false, name : "Enh narrowband remove green", type : 'B', oldname: "Extra narrowband remove green", applies : "narrowband" },
      remove_magenta_color: { val: false, def: false, name : "Enh remove magenta color", type : 'B', oldname: "Extra remove magenta color", applies : "narrowband" },
      fix_narrowband_star_color: { val: false, def: false, name : "Enh narrowband fix star colors", type : 'B', oldname: "Extra narrowband fix star colors", applies : "narrowband" },
      skip_star_fix_mask: { val: false, def: false, name : "Enh narrowband no star mask", type : 'B', oldname: "Extra narrowband no star mask", applies : "narrowband" },
      ...
      enhancements_HDRMLT_color: { val: 'None', def: 'None', name : "Enh HDRMLT hue", type : 'S', oldname: "Extra HDRMLT hue", applies : "color" },
      ...
      enhancements_auto_contrast_channels: { val: false, def: false, name : "Enh auto contrast channels", type : 'B', oldname: "Extra auto contrast channels", applies : "mono" },
      ...
      enhancements_normalize_channels: { val: false, def: false, name : "Enh normalize channels", type : 'B', oldname: "Extra normalize channels", applies : "color mono" },
      enhancements_normalize_channels_reference: { val: 'G', def: 'G', name : "Enh normalize channels reference", type : 'S', oldname: "Extra normalize channels reference", applies : "color mono" },
      enhancements_normalize_channels_mask: { val: false, def: false, name : "Enh normalize channels mask", type : 'B', oldname: "Extra normalize channels mask", applies : "color mono" },
      enhancements_normalize_channels_rescale: { val: false, def: false, name : "Enh normalize channels rescale", type : 'B', oldname: "Extra normalize channels rescale", applies : "color mono" },
      enhancements_adjust_channels: { val: false, def: false, name : "Enh adjust channels", type : 'B', oldname: "Extra adjust channels", applies : "color" },
      enhancements_adjust_channels_only_k: { val: false, def: false, name : "Enh adjust channels K", type : 'B', oldname: "Extra adjust channels K", applies : "color" },
      enhancements_adjust_R: { val: 1, def: 1, name : "Enh adjust R", type : 'R', oldname: "Extra adjust R", applies : "color" },
      enhancements_adjust_G: { val: 1, def: 1, name : "Enh adjust G", type : 'R', oldname: "Extra adjust G", applies : "color" },
      enhancements_adjust_B: { val: 1, def: 1, name : "Enh adjust B", type : 'R', oldname: "Extra adjust B", applies : "color" },
      ...
      enhancements_auto_reset: { val: true, def: true, name : "Enh auto reset", type : 'B', oldname: "Extra auto reset", applies : "interface" },
      ...
      enhancements_color_noise: { val: false, def: false, name : "Enh color noise reduction", type : 'B', oldname: "Extra color noise reduction", applies : "color" },
      ...
      enhancements_highpass_sharpen_keep_images: { val: false, def: false, name : "Enh highpass sharpen keep images", type : 'B', oldname: "Extra highpass sharpen keep images", applies : "interface" },
      ...
      enhancements_saturation: { val: false, def: false, name : "Enh saturation", type : 'B', oldname: "Extra saturation", applies : "color" },
      enhancements_saturation_iterations: { val: 1, def: 1, name : "Enh saturation iterations", type : 'I', oldname: "Extra saturation iterations", applies : "color" },
      enhancements_less_saturation: { val: false, def: false, name : "Enh less saturation", type : 'B', applies : "color" },
      ...
      enhancements_apply_no_copy_image: { val: false, def: false, name : "Apply no copy image", type : 'B', applies : "interface" },
      ...
      enhancements_color_calibration: { val: false, def: false, name : "Enh color calibration", type : 'B', oldname: "Extra color calibration", applies : "color" },
      ...
      enhancements_ha_mapping: { val: false, def: false, name : "Enh ha mapping", type : 'B', oldname: "Extra ha mapping", applies : "narrowband" },
      enhancements_highlight_color: { val: false, def: false, name : "Enh highlight color", type : 'B', applies : "color" },

      // Calibration settings
      debayer_pattern: { val: "Auto", def: "Auto", name : "Debayer", type : 'S', applies : "color osc" },
      banding_reduction: { val: false, def: false, name : "Banding reduction", type : 'B', applies : "color osc" },
      banding_reduction_protect_highlights: { val: false, def: false, name : "Banding reduction protect highlights", type : 'B', applies : "color osc" },
      banding_reduction_amount: { val: 1, def: 1, name : "Banding reduction amount", type : 'R', applies : "color osc" },
      extract_channel_mapping: { val: "None", def: "None", name : "Extract channel mapping", type : 'S', applies : "color osc" },
      ...
      lights_add_manually: { val: false, def: false, name : "Add lights manually", type : 'B', applies : "interface" },
      integrated_lights: { val: false, def: false, name : "Integrated lights", type : 'B', applies : "interface" },
      flats_add_manually: { val: false, def: false, name : "Add flats manually", type : 'B', applies : "interface" },
      flatdarks_add_manually: { val: false, def: false, name : "Add flat darks manually", type : 'B', applies : "interface" },
      skip_blink: { val: false, def: false, name : "No blink", type : 'B', used: true, applies : "interface" },  // Only if not using preview
      ...
      start_with_empty_window_prefix: { val: false, def: false, name: "startWithEmptyPrefixName", type: 'B', applies : "interface" }, // Do we always start with empty prefix
      use_manual_icon_column: { val: false, def: false, name: "manualIconColumn", type: 'B', applies : "interface" }                  // Allow manual control of icon column
};
