...
function AutoIntegrateEnhancements(parent, guitools, util, global, engine, preview)
{
...
function apply_undo()
{
      ...
      if (global.enhancements_target_image == null || global.enhancements_target_image == "Auto") {
      ...
      console.noteln("Undo on image " + global.enhancements_target_image + " (" + enhancements_gui_info.undo_images_pos + "/" + enhancements_gui_info.undo_images.length + ")");
      var target_win = ImageWindow.windowById(global.enhancements_target_image);
      if (target_win == null) {
            console.criticalln("Failed to find target image " + global.enhancements_target_image);
            return;
      }
      ...
      preview.updatePreviewIdReset(global.enhancements_target_image, true, source_histogramInfo);
...
function apply_redo()
{
      ...
      console.noteln("Redo on image " + global.enhancements_target_image + " (" + (enhancements_gui_info.undo_images_pos + 2) + "/" + enhancements_gui_info.undo_images.length + ")");
      var target_win = ImageWindow.windowById(global.enhancements_target_image);
      if (target_win == null) {
            console.criticalln("Failed to find target image " + global.enhancements_target_image);
            return;
...
function save_as_undo()
{
      ...
      saveFileDialog.initialPath = path + global.enhancements_target_image + ".xisf";
      if (!saveFileDialog.execute()) {
            console.noteln("Image " + global.enhancements_target_image + " not saved");
            return;
      }
      ...
      var save_win = ImageWindow.windowById(global.enhancements_target_image);
      ...
      */
      ...
      console.noteln("Save " + global.enhancements_target_image + " as " + filename);
      ...
      */
      ...
      if (save_id != global.enhancements_target_image) {
            // Rename old image
...
function getNarrowbandColorizedSizer(parent)
{
      ...
      function narrowbandColorizedPreview(mosaic) {
            ...
            if (global.enhancements_target_image == 'Auto') {
                  ...
                  var enhancementsWin = ImageWindow.windowById(global.enhancements_target_image);
...
// Foraxx mapping
this.narrowband_Foraxx_CheckBox = guitools.newCheckBox(parent, "Foraxx mapping", par.run_foraxx_mapping, 
...
this.narrowband_Foraxx_palette_ComboBox = guitools.newComboBox(parent, par.foraxx_palette, Foraxx_palette_values, this.narrowband_Foraxx_CheckBox.toolTip);
...
for (var i = 0; i < global.narrowBandPalettes.length; i++) {
      if (global.narrowBandPalettes[i].sho_mappable) {
            this.enhancements_SHO_mapping_values.push(global.narrowBandPalettes[i].name);
      }
}
this.enhancements_narrowband_mapping_CheckBox = guitools.newCheckBox(parent, "Narrowband mapping", par.run_enhancements_narrowband_mapping, 
...
this.enhancements_narrowband_source_palette_ComboBox = guitools.newComboBox(parent, par.enhancements_narrowband_mapping_source_palette, Foraxx_palette_values, this.enhancements_narrowband_mapping_CheckBox.toolTip);
this.enhancements_narrowband_target_mapping_Label = guitools.newLabel(parent, "to", this.enhancements_narrowband_mapping_CheckBox.toolTip);
this.enhancements_narrowband_target_palette_ComboBox = guitools.newComboBox(parent, par.enhancements_narrowband_mapping_target_palette, this.enhancements_SHO_mapping_values, this.enhancements_narrowband_mapping_CheckBox.toolTip);
...
this.narrowband_orangeblue_colors_CheckBox = guitools.newCheckBox(parent, "Orange/blue colors", par.run_orangeblue_colors, 
      "<p>Enhance image by shifting red colors more to  orange and enhancing blues. Useful for example with Foraxx palette.</p>");

this.fix_narrowband_star_color_CheckBox = guitools.newCheckBox(parent, "Fix star colors", par.fix_narrowband_star_color, 
...
// this.narrowband_less_green_hue_shift_CheckBox = guitools.newCheckBox(parent, "Hue shift for less green", par.run_less_green_hue_shift, 
//       "<p>Do hue shift to shift green color to the yellow color. Useful with SHO color palette.</p>" );
this.narrowband_orange_hue_shift_CheckBox = guitools.newCheckBox(parent, "Hue shift for more orange", par.run_orange_hue_shift, 
      "<p>Do hue shift to enhance orange color. Useful with SHO color palette.</p>" );
this.narrowband_hue_shift_CheckBox = guitools.newCheckBox(parent, "Hue shift for SHO", par.run_hue_shift, 
...
this.narrowband_leave_some_green_CheckBox = guitools.newCheckBox(parent, "Leave some green", par.leave_some_green, 
      "<p>Leave some green color on image when running SCNR. Useful with SHO color palette. </p>");
this.narrowband_leave_some_green_Edit = guitools.newNumericEdit(parent, "Amount", par.leave_some_green_amount, 0, 1, 
...
this.run_narrowband_SCNR_CheckBox = guitools.newCheckBox(parent, "Remove green cast", par.run_narrowband_SCNR, 
      "<p>Run SCNR to remove green cast. Useful with SHO color palette.</p>");
this.no_star_fix_mask_CheckBox = guitools.newCheckBox(parent, "No mask when fixing star colors", par.skip_star_fix_mask, 
      "<p>Do not use star mask when fixing star colors</p>" );
this.remove_magenta_color_CheckBox = guitools.newCheckBox(parent, "Remove magenta color", par.remove_magenta_color, 
...
this.enhancementsRemoveStars_CheckBox = guitools.newCheckBox(parent, "Remove stars", par.enhancements_remove_stars, enhancementsRemoveStars_Tooltip);
this.enhancementsUnscreenStars_CheckBox = guitools.newCheckBox(parent, "Unscreen", par.enhancements_unscreen_stars, guitools.unscreen_tooltip);
...
this.enhancementsCombineStars_CheckBox = guitools.newCheckBox(parent, "Combine starless and stars", par.enhancements_combine_stars, enhancementsCombineStars_Tooltip);
this.enhancementsCombineStars_ComboBox = guitools.newComboBox(parent, par.enhancements_combine_stars_mode, guitools.starless_and_stars_combine_values, enhancementsCombineStars_Tooltip);
...
this.enhancementsCombineStarsReduce_ComboBox = guitools.newComboBox(parent, par.enhancements_combine_stars_reduce, star_reduce_methods, 
      enhancementsCombineStarsReduce_Tooltip);
this.enhancementsCombineStarsReduce_S_edit = guitools.newNumericEdit(parent, 'S', par.enhancements_combine_stars_reduce_S, 0.0, 1.0, 
...
this.enhancementsCombineStarsReduce_M_Label = guitools.newLabel(parent, "I", enhancementsCombineStarsReduce_M_toolTip);
this.enhancementsCombineStarsReduce_M_SpinBox = guitools.newSpinBox(parent, par.enhancements_combine_stars_reduce_M, 1, 3, 
...
this.enhancementsStarsImageEdit = guitools.newTextEdit(parent, par.enhancements_combine_stars_image, this.enhancementsStarsImageLabel.toolTip);
...
this.enhancementsDarkerBackground_CheckBox = guitools.newCheckBox(parent, "Darker background", par.enhancements_darker_background, 
      "<p>Make image background darker using a lightness mask.</p>" );
this.enhancementsDarkerHighlights_CheckBox = guitools.newCheckBox(parent, "Darker highlights", par.enhancements_darker_highlights, 
      "<p>Make image highlights darker using a lightness mask.</p>" );

this.enhancements_backgroundneutralization_CheckBox = guitools.newCheckBox(parent, "Background neutralization", par.enhancements_backgroundneutralization, 
...
this.enhancements_GC_Sizer.add( this.enhancements_GC_values_ComboBox );
this.enhancements_GC_Sizer.addStretch();

this.enhancementsBandinReduction_CheckBox = guitools.newCheckBox(parent, "Banding reduction", par.enhancements_banding_reduction, 
      "<p>Run banding reduction on the image.</p>" );

var enhancements_ET_tooltip = "<p>Run ExponentialTransform on image using a mask.</p>";
this.enhancements_ET_CheckBox = guitools.newCheckBox(parent, "ExponentialTransform,", par.enhancements_ET, enhancements_ET_tooltip);
this.enhancements_ET_order_edit = guitools.newNumericEdit(parent, 'Order', par.enhancements_ET_order, 0.1, 6, "Order value for ExponentialTransform.");
this.enhancements_ET_adjust_label = guitools.newLabel(parent, "Adjust", "<p>Adjust type to be used with ExponentialTransform.</p>" +
                                                            "<p>Lightness mask is used to get the desired adjustment.</p>" +
                                                            guitools.adjust_type_toolTip);
this.enhancements_ET_adjust_Combobox = guitools.newComboBox(parent, par.enhancements_ET_adjusttype, adjust_type_values, this.enhancements_ET_adjust_label.toolTip);
...
this.enhancements_HDRMLT_CheckBox = guitools.newCheckBox(parent, "HDRMultiscaleTransform", par.enhancements_HDRMLT, enhancements_HDRMLT_tooltip);

this.enhancements_HDRMLT_Layers_Label = new Label( parent );
this.enhancements_HDRMLT_Layers_Label.text = "Layers";
this.enhancements_HDRMLT_Layers_Label.textAlignment = TextAlign_Left|TextAlign_VertCenter;
this.enhancements_HDRMLT_Layers_Label.toolTip = enhancements_HDRMLT_tooltip;
this.enhancements_HDRMLT_Layers_SpinBox = guitools.newSpinBox(parent, par.enhancements_HDRMLT_layers, 2, 10, enhancements_HDRMLT_tooltip);
this.enhancements_HDRMLT_Overdrive_Edit = guitools.newNumericEditPrecision(parent, "Overdrive", par.enhancements_HDRMLT_overdrive, 0, 1, enhancements_HDRMLT_tooltip, 3);
this.enhancements_HDRMLT_Iterations_Label = guitools.newLabel(parent, "Iterations", enhancements_HDRMLT_tooltip);
this.enhancements_HDRMLT_Iterations_SpinBox = guitools.newSpinBox(parent, par.enhancements_HDRMLT_iterations, 1, 16, enhancements_HDRMLT_tooltip);

this.enhancements_HDRMLT_Color_Label = new Label( parent );
this.enhancements_HDRMLT_Color_Label.text = "Color";
this.enhancements_HDRMLT_Color_Label.textAlignment = TextAlign_Left|TextAlign_VertCenter;
this.enhancements_HDRMLT_Color_Label.toolTip = enhancements_HDRMLT_tooltip;
this.enhancements_HDRMLT_color_ComboBox = guitools.newComboBox(parent, par.enhancements_HDRMLT_color, enhancements_HDRMLT_color_values, enhancements_HDRMLT_tooltip);
...
this.enhancements_LHE_CheckBox = guitools.newCheckBox(parent, "LocalHistogramEqualization,", par.enhancements_LHE, enhancements_LHE_tooltip);
this.enhancements_LHE_kernelradius_edit = guitools.newNumericEdit(parent, 'Kernel Radius', par.enhancements_LHE_kernelradius, 16, 512, "<p>Kernel radius value for LocalHistogramEqualization.</p>");
this.enhancements_LHE_contrastlimit_edit = guitools.newNumericEdit(parent, 'Contrast limit', par.enhancements_LHE_contrastlimit, 1, 64, 
...
this.enhancements_LHE_adjust_label = guitools.newLabel(parent, "Adjust", "<p>Mask type to be used with LocalHistogramEqualization.</p>" +
                                                            "<p>Lightness mask is used to get the desired adjustment.</p>" +
                                                            guitools.adjust_type_toolTip +
                                                            "<p>With darks adjust usually you should increase the contrast limit value, for example 2.5.</p>");
this.enhancements_LHE_adjust_Combobox = guitools.newComboBox(parent, par.enhancements_LHE_adjusttype, adjust_type_values, this.enhancements_LHE_adjust_label.toolTip);
...
this.enhancements_Contrast_CheckBox = guitools.newCheckBox(parent, "Add contrast", par.enhancements_contrast, 
      "<p>Run slight S shape curves transformation on image to add contrast.</p>" );
this.contrastIterationsSpinBox = guitools.newSpinBox(parent, par.enhancements_contrast_iterations, 1, 5, "Number of iterations for contrast enhancement");
...
this.enhancementsAutoContrastCheckBox = guitools.newCheckBox(parent, "Auto contrast,", par.enhancements_auto_contrast, enhancementsAutoContrastTooltip);
this.enhancementsAutoContrastEditLow = guitools.newNumericEditPrecision(parent, 'low', par.enhancements_auto_contrast_limit_low, 0, 100, "Percentage of clipped low pixels.", 4);
this.enhancementsAutoContrastEditHigh = guitools.newNumericEditPrecision(parent, 'high', par.enhancements_auto_contrast_limit_high, 0, 100, "Percentage of preserved high pixels.", 4);
this.enhancementsAutoContrastChannelsCheckBox = guitools.newCheckBox(parent, "channels", par.enhancements_auto_contrast_channels, "Apply auto contrast separately for each channel.");
...
this.enhancements_signature_path_Edit = guitools.newTextEdit(parent, par.enhancements_signature_path, "Path to signature file.");
...
this.enhancements_signature_scale_Label = guitools.newLabel(parent, "Scale", 
...
this.enhancements_signature_scale_SpinBox = guitools.newSpinBox(parent, par.enhancements_signature_scale, 0, 100, this.enhancements_signature_scale_Label.toolTip);
this.enhancements_signature_position_ComboBox = guitools.newComboBox(parent, par.enhancements_signature_position, signature_positions_values, "<p>Signature position.</p>");

this.enhancements_force_new_mask_CheckBox = guitools.newCheckBox(parent, "New mask", par.enhancements_force_new_mask, 
      "<p>Do not use existing mask but create a new luminance or star mask when needed.</p>" );
this.enhancements_range_mask_CheckBox = guitools.newCheckBox(parent, "range_mask", par.enhancements_range_mask, 
...
this.enhancements_auto_reset_CheckBox = guitools.newCheckBox(parent, "Auto reset", par.enhancements_auto_reset, 
...
this.enhancements_shadowclip_CheckBox = guitools.newCheckBox(parent, "Adjust shadows,", par.enhancements_shadowclipping, shadowclipTooltip);
this.enhancements_shadowclipperc_edit = guitools.newNumericEditPrecision(parent, '%', par.enhancements_shadowclippingperc, 0, 100, shadowclipTooltip, 4);
...
this.enhancementsEnhanceShadowsCheckBox = guitools.newCheckBox(parent, "Enhance shadows", par.enhancements_shadow_enhance, enhancementsEnhanceShadowsTooltip);
...
this.enhancementsEnhanceHighlightsCheckBox = guitools.newCheckBox(parent, "Enhance highlights", par.enhancements_highlight_enhance, enhancementsEnhanceHighlightsTooltip);
...
this.enhancementsGammaCheckBox = guitools.newCheckBox(parent, "Gamma", par.enhancements_gamma, enhancementsGammaTooltip);
this.enhancementsGammaEdit = guitools.newNumericEdit(parent, '', par.enhancements_gamma_value, 0, 2, enhancementsGammaTooltip);
...
this.enhancements_smoothBackground_CheckBox = guitools.newCheckBox(parent, "Smoothen background,", par.enhancements_smoothbackground, smoothBackgroundTooltip);
this.enhancements_smoothBackgroundval_edit = guitools.newNumericEditPrecision(parent, 'value', par.enhancements_smoothbackgroundval, 0, 100, smoothBackgroundTooltip, 4);
this.enhancements_smoothBackgroundfactor_edit = guitools.newNumericEditPrecision(parent, 'factor', par.enhancements_smoothbackgroundfactor, 0, 10, smoothBackgroundTooltip, 2);
...
this.enhancementsNormalizeChannelsCheckBox = guitools.newCheckBox(parent, "Normalize channels,", par.enhancements_normalize_channels, 
...
this.enhancementsNormalizeChannelsReferenceLabel = guitools.newLabel(parent, "reference", "Reference channel for normalization." + this.enhancementsNormalizeChannelsCheckBox.toolTip);
this.enhancementsNormalizeChannelsReferenceComboBox = guitools.newComboBox(parent, par.enhancements_normalize_channels_reference, normalize_channels_reference_values, this.enhancementsNormalizeChannelsReferenceLabel.toolTip);
this.enhancementsNormalizeChannelsMaskCheckBox = guitools.newCheckBox(parent, "Mask", par.enhancements_normalize_channels_mask, 
...
this.enhancementsNormalizeChannelsRescaleCheckBox = guitools.newCheckBox(parent, "Rescale", par.enhancements_normalize_channels_rescale, 
...
this.enhancementsAdjustChannelsCheckBox = guitools.newCheckBox(parent, "Adjust channels,", par.enhancements_adjust_channels, enhancementsAdjustChannelsToolTip);
this.enhancementsAdjustChannelR = guitools.newNumericEdit(parent, "R/K", par.enhancements_adjust_R, 0, 100, enhancementsAdjustChannelsToolTip);
this.enhancementsAdjustChannelG = guitools.newNumericEdit(parent, "G", par.enhancements_adjust_G, 0, 100, enhancementsAdjustChannelsToolTip);
this.enhancementsAdjustChannelB = guitools.newNumericEdit(parent, "B", par.enhancements_adjust_B, 0, 100, enhancementsAdjustChannelsToolTip);
...
this.enhancementsAdjustChannelsOnlyKCheckBox = guitools.newCheckBox(parent, "Only K", par.enhancements_adjust_channels_only_k, enhancementsAdjustChannelsToolTip);
...
this.enhancements_SmallerStars_CheckBox = guitools.newCheckBox(parent, "Smaller stars", par.enhancements_smaller_stars, 
      "<p>Make stars smaller on image.</p>" );
this.smallerStarsIterationsSpinBox = guitools.newSpinBox(parent, par.enhancements_smaller_stars_iterations, 0, 10, 
...
this.enhancements_NoiseReduction_CheckBox = guitools.newCheckBox(parent, "Noise reduction", par.enhancements_noise_reduction, 
...
this.enhancements_solve_image_Button.onClick = function()
{
      ...
      if (util.copyAstrometricSolutionFromFile(global.enhancements_target_image, ofd.fileName)) {
...
this.enhancements_annotate_image_CheckBox = guitools.newCheckBox(parent, "Annotate", par.enhancements_annotate_image, 
...
this.enhancementsSetClippedPixelsButton.icon = parent.scaledResource(":/icons/clap.png");
this.enhancementsSetClippedPixelsButton.toolTip = guitools.clippedPixelsToolTip;
this.enhancementsSetClippedPixelsButton.setScaledFixedSize( 20, 20 );
this.enhancementsSetClippedPixelsButton.onClick = function()
{
...
this.enhancements_sharpen_CheckBox = guitools.newCheckBox(parent, "Sharpening", par.enhancements_sharpen, enhancements_sharpen_tooltip);

this.enhancementsSharpenIterationsSpinBox = guitools.newSpinBox(parent, par.enhancements_sharpen_iterations, 1, 10, enhancements_sharpen_tooltip);
this.enhancementsSharpenIterationsLabel = new Label( parent );
this.enhancementsSharpenIterationsLabel.text = "iterations";
this.enhancementsSharpenIterationsLabel.textAlignment = TextAlign_Left|TextAlign_VertCenter;
...
this.enhancements_unsharpmask_CheckBox = guitools.newCheckBox(parent, "UnsharpMask,", par.enhancements_unsharpmask, unsharpmask_tooltip);
this.enhancementsUnsharpMaskStdDevEdit = guitools.newNumericEdit(parent, "StdDev", par.enhancements_unsharpmask_stddev, 0.1, 250, unsharpmask_tooltip);
this.enhancementsUnsharpMaskAmountEdit = guitools.newNumericEdit(parent, "Amount", par.enhancements_unsharpmask_amount, 0.1, 1.00, unsharpmask_tooltip);
...
this.enhancements_highpass_sharpen_CheckBox = guitools.newCheckBox(parent, "High pass sharpen", par.enhancements_highpass_sharpen, highpass_sharpen_tooltip);
this.enhancements_highpass_sharpen_ComboBox = guitools.newComboBox(parent, par.enhancements_highpass_sharpen_method, highpass_sharpen_values, 
      ...
      "Settings for iterations are taken from the <i>Enhancements / Generic enhancements</i> section <i>Sharpening</i> options.</li>" +
      ...
      "<li>Option 'BlurXTerminator' uses BlurXTerminator on a high pass image. Settings are taken from the <i>Tools / BlurXTerminator</i> section.</li>" +
      "</ul>"
);
this.enhancements_highpass_sharpen_Label = guitools.newLabel(parent, "Layers", "<p>Number of layers used to blur the original image.</p>");
this.enhancements_highpass_sharpen_SpinBox = guitools.newSpinBox(parent, par.enhancements_highpass_sharpen_layers, 1, 7, this.enhancements_highpass_sharpen_Label.toolTip);
...
this.enhancements_highpass_sharpen_noise_reduction_CheckBox = guitools.newCheckBox(parent, "Noise reduction", par.enhancements_highpass_sharpen_noise_reduction, 
      "<p>Do noise reduction on high pass image before sharpening.</p>");
this.enhancements_highpass_sharpen_keep_images_CheckBox = guitools.newCheckBox(parent, "Keep images", par.enhancements_highpass_sharpen_keep_images, 
      "<p>Do not delete low pass and high pass images.</p>");
this.enhancements_highpass_sharpen_combine_only_CheckBox = guitools.newCheckBox(parent, "Combine only", par.enhancements_highpass_sharpen_combine_only, 
...
this.enhancements_saturation_CheckBox = guitools.newCheckBox(parent, "Saturation", par.enhancements_saturation, enhancements_saturation_tooltip);

this.enhancementsSaturationIterationsSpinBox = guitools.newSpinBox(parent, par.enhancements_saturation_iterations, 1, 20, enhancements_saturation_tooltip);
this.enhancementsSaturationIterationsLabel = new Label( parent );
this.enhancementsSaturationIterationsLabel.text = "iterations";
this.enhancementsSaturationIterationsLabel.textAlignment = TextAlign_Left|TextAlign_VertCenter;
...
this.enhancements_clarity_CheckBox = guitools.newCheckBox(parent, "Clarity,", par.enhancements_clarity, clarity_tooltip);
this.enhancementsClarityStdDevEdit = guitools.newNumericEdit(parent, "StdDev", par.enhancements_clarity_stddev, 0.1, 250, clarity_tooltip);
this.enhancementsClarityAmountEdit = guitools.newNumericEdit(parent, "Amount", par.enhancements_clarity_amount, 0.1, 1.00, clarity_tooltip);
this.enhancementsClarityMaskCheckBox = guitools.newCheckBox(parent, "Mask", par.enhancements_clarity_mask, clarity_tooltip);
...
this.enhancementsImageLabel.textAlignment = TextAlign_Left|TextAlign_VertCenter;
...
this.enhancementsImageComboBox.minItemCharWidth = 20;
this.enhancementsImageComboBox.onItemSelected = function( itemIndex )
{
      if (global.enhancements_target_image == enhancements_target_image_window_list[itemIndex]) {
            return;
      }
      close_undo_images();
...
this.enhancementsLoadTargetImageButton.onClick = function()
{
      ...
      global.enhancements_target_image = imageWindow.mainView.id;
      console.writeln("global.enhancements_target_image " + global.enhancements_target_image);
      enhancements_gui_info.save_button.enabled = true;
      update_enhancements_target_image_window_list(global.enhancements_target_image);
};
...
this.enhancementsApplyButton.onClick = function()
{
      ...
      } else if (global.enhancements_target_image == null) {
            console.criticalln("No image!");
      } else if (global.enhancements_target_image == "Auto") {
            console.criticalln("Auto target image cannot be used with Apply button!");
      } else if (util.findWindow(global.enhancements_target_image) == null) {
            console.criticalln("Could not find target image " + global.enhancements_target_image);
      } else {
            if (enhancements_gui_info.undo_images.length == 0) {
                  global.enhancements_info = [];   // First image, clear enhancements info
                  var saved_enhancements_target_image = global.enhancements_target_image;
                  if (!par.enhancements_apply_no_copy_image.val) {
                        // make copy of the original image
                        global.enhancements_target_image = copy_new_edit_image(global.enhancements_target_image);
                  }
                  var first_undo_image = create_undo_image(global.enhancements_target_image);
                  var first_undo_image_histogramInfo = global.enhancements_target_histogram_info;
            } else {
                  var first_undo_image = null;
            }
            console.writeln("Apply enhancements edits on " + global.enhancements_target_image);
            try {
                  engine.enhancementsApply = true;
                  global.haveIconized = 0;

                  engine.enhancementsProcessingEngine(parent.dialog, global.enhancements_target_image, util.is_narrowband_option());
                  ...
                  if (first_undo_image != null) {
                        global.enhancements_target_image = saved_enhancements_target_image;
                  }
...
enhancements_gui_info.undo_button = this.enhancementsUndoButton;
...
enhancements_gui_info.redo_button = this.enhancementsRedoButton;
...
enhancements_gui_info.save_button = this.enhancementsSaveButton;
...
{
      var win = util.findWindow(global.enhancements_target_image);
      if (win == null) {
            console.criticalln("No image");
            return;
      }
...
this.enhancements_rotate_CheckBox = guitools.newCheckBox(parent, "Rotate", par.enhancements_rotate, 
      "<p>Rotate the image in clockwise direction.</p>" );
this.enhancements_rotate_degrees_ComboBox = guitools.newComboBox(parent, par.enhancements_rotate_degrees, rotate_degrees_values, this.enhancements_rotate_CheckBox.toolTip);
this.enhancements_image_no_copy_CheckBox = guitools.newCheckBox(parent, "No copy", par.enhancements_apply_no_copy_image, 
...
this.enhancementsImageOptionsSizer1.add( this.enhancements_rotate_CheckBox );
this.enhancementsImageOptionsSizer1.add( this.enhancements_rotate_degrees_ComboBox );
this.enhancementsImageOptionsSizer1.add( this.enhancements_color_calibration_CheckBox );
...
this.enhancements1.add( this.enhancementsRemoveStars_Sizer );
this.enhancements1.add( this.enhancementsFixStarCores_CheckBox );
...
this.enhancements2.add( this.enhancements_star_noise_reduction_CheckBox );
...
this.enhancements2.add( this.enhancementsSmallerStarsSizer );
this.enhancements2.add( this.enhancementsCombineStars_Sizer );
...
this.enhancementsImageControl = new Control( parent );
this.enhancementsImageControl.sizer = new VerticalSizer;
this.enhancementsImageControl.sizer.margin = 6;
this.enhancementsImageControl.sizer.spacing = 4;
this.enhancementsImageControl.sizer.add( this.enhancementsImageSizer );
this.enhancementsImageControl.sizer.add( this.enhancementsImageOptionsSizer );
this.enhancementsImageControl.sizer.addStretch();
this.enhancementsImageControl.visible = true;

this.enhancementsControl1 = new Control( parent );
this.enhancementsControl1.sizer = new VerticalSizer;
this.enhancementsControl1.sizer.margin = 6;
this.enhancementsControl1.sizer.spacing = 4;
this.enhancementsControl1.sizer.add( this.enhancementsGroupBoxSizer );
this.enhancementsControl1.sizer.addStretch();
this.enhancementsControl1.visible = true;

this.enhancementsControl2 = new Control( parent );
...
this.enhancementsControl3 = new Control( parent );
this.enhancementsControl3.sizer = new VerticalSizer;
this.enhancementsControl3.sizer.margin = 6;
this.enhancementsControl3.sizer.spacing = 4;
this.enhancementsControl3.sizer.add( this.narrowbandColorized_sizer );
this.enhancementsControl3.sizer.addStretch();
this.enhancementsControl3.visible = false;

this.getEnhancementsGUIControls = function()
{
      return [ this.enhancementsImageControl, this.enhancementsControl1, this.enhancementsControl2, this.enhancementsControl3 ];
}
...
AutoIntegrateEnhancements.prototype = new Object;
